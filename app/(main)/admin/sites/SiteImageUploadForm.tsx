...
import { uploadSiteImages, type ActionState } from './actions';

const MAX_FILE_SIZE_BYTES = 5 * 1024 * 1024;
const MAX_TOTAL_SIZE_BYTES = 20 * 1024 * 1024;

export function SiteImageUploadForm({ slug }: { slug: string }) {
  const uploadAction = uploadSiteImages.bind(null, slug);
